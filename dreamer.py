...
class Dreamer:
    ...
    def train_one_batch(self):
        ...
        self.actor_opt.step()
        # Example: In the training loop
        self.collect_agent_states()
    ...
    def collect_agent_states(self):
         """Collect the agent's internal states for logging or analysis."""
         agent_states = self.rssm.get_states()
         self.agent_states_log.append(agent_states)

    def save(self, save_path):
        states = {
                'rssm': self.rssm.get_states(),
